...
person_df1 <- read.csv("data/tidynomicon/person.csv",TRUE)
str(person_df1)
...
scores_df <- read.csv("data/scores.csv",TRUE)
summary(scores_df)
...
cols = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout")
